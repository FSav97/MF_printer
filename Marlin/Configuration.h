...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP 17.80 //22.00
    #define DEFAULT_KI 1.72 //1.08
    #define DEFAULT_KD 46.20//40.00
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 48.02
  #define DEFAULT_BED_KI 6.98
  #define DEFAULT_BED_KD 220.31
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.2, 80.25, 400, 428.4 }
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 2000, 2000, 200, 8000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, -41, -3.2 }
...
#define XY_PROBE_FEEDRATE    10000 // (mm/min)
...
#define Z_PROBE_LOW_POINT          -6.5 // (mm) Farthest distance below the trigger-point to go before stopping
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), 400 }
